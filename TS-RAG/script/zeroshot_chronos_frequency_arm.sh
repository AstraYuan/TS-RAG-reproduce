...
filename=${SAVE_FILE_NAME:-zeroshot_chronos_frequency_arm.txt}
...
default_freq_model_id="data50m_${augment_mode}_${seq_len}_pred${pred_len}_lookback${lookback_length}_top${top_k}_lr0.0003_drop0.2_adamw_cosanneal_step10000_bs256_no_embeddingtuning"
checkpoint_model_path=${FREQUENCY_ARM_CHECKPOINT_PATH:-"./checkpoints/${default_freq_model_id}/model_steps9999.pth"}
